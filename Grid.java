public class Grid
{
   ...
   private static final String HEADER_COLS = "   1️⃣ 2️⃣ 3️⃣ 4️⃣ 5️⃣ 6️⃣ 7️⃣ 8️⃣ 9️⃣ 🔟 ";
   private static final String HEADER_ROWS = "ⒶⒷⒸⒹⒺⒻⒼⒽⒾⒿ";

   private static final String[] STATUS_STRINGS = {"🌊", "☠️", "✌️"};
